...
class SketchSdkPanel : public QDialog
{
    Q_OBJECT
public:
    explicit SketchSdkPanel(const QString& workshopName, const QString& projectPath, const QString& workshopStatus,
                            QWidget* parent = nullptr);
    SketchSdkPanel(const QString& workshopName, const QString& projectPath, const QString& workshopStatus,
                   const SketchSdkData& prefillData, QWidget* parent = nullptr);
...
private:
    ...
    void addPlugRow(const QString& name = QString(), const QString& interfaceName = QStringLiteral("mount"),
                    const QString& workshopTarget = QString());
    void addSlotRow(const QString& name = QString(), const QString& interfaceName = QStringLiteral("tunnel"),
                    int endpoint = 8080);
