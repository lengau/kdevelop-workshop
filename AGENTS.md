...
- **Testing New Code**: Add or update automated tests for new or changed behavior whenever feasible. If tests are not feasible, explicitly document why in the PR description or commit message.
